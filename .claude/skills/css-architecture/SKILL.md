...
description: Guides CSS edits for the ComPair website. Use when changing colors, typography, component styles, adding page-specific CSS, or working with the CSS architecture (theme files, shared components, page-specific styles).
---
