...
description: Multi-source affiliate system for ComPair - supports Shopee and Lazada with GA4 tracking and A/B testing. Use when working with affiliate links, product feeds, guide picks, Shopee short links, Lazada API, or affiliate tracking implementation.
---
