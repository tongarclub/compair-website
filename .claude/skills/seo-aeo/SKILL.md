---
name: seo-aeo
description: Guides SEO and AEO (Answer Engine Optimization) work for the ComPair website. Use when working with static JSON-LD schemas, meta tags, Open Graph, sitemap.xml, robots.txt, canonical URLs, FAQ content, or when adding new pages that need search visibility optimization.
---
